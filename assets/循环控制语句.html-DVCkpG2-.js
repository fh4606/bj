import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,d as e}from"./app-fmcy30Ms.js";const i={},l=e(`<h2 id="一、循环控制-break语句" tabindex="-1"><a class="header-anchor" href="#一、循环控制-break语句"><span>一、循环控制-break语句</span></a></h2><p>作用: 终止循环，执行循环体后面的代码 <strong>案例:</strong> 循环打印输出数字1到9，当执行输出到5时终止循环。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>要求输出：</span></span>
