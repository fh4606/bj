import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as e,o as l,d as s,a as n}from"./app-CAdWGPj0.js";const i={},p=s(`<p>处理海量日志对每一个运维来说都非常的头疼，日志分析我们首先需要把需要的数据从海量的日志中匹配出来，降低数据量，然后在分析这些日志。那么从海量的日志中把我们需要的日志找出来就需要我们写一个公式来匹配，那么如何才能写一个这样的公式呢？</p><p>这节课我就给大家说说正则表达式，看起来比较高大上，其实就是通过给定的符号生成一个字符串匹配的公式，通过该公式把需要的数据匹配出来。</p><p>比如</p><ul><li>匹配正确的IP地址</li><li>匹配正确的e-mail地址</li></ul><h2 id="正则表达式" tabindex="-1"><a class="header-anchor" href="#正则表达式"><span>正则表达式</span></a></h2><h3 id="_1、正则表达式介绍" tabindex="-1"><a class="header-anchor" href="#_1、正则表达式介绍"><span>1、正则表达式介绍</span></a></h3><p><strong>正则表达式</strong>（Regular Expression、regex或regexp，缩写为RE），也译为正规表示法、常规表示法，是一种字符模式，用于在查找过程中匹配指定的字符。</p><p>许多程序设计语言都支持利用正则表达式进行<strong>字符串操作</strong>。例如，在Perl中就内建了一个功能强大的正则表达式引擎。</p><p>正则表达式这个概念最初是由Unix中的工具软件（例如sed和grep）普及开的。</p><p><strong>支持正则表达式的程序如：locate |find| vim| grep| sed |awk</strong></p><p><strong>正则表达式是一个三方产品，被常用计算机语言广泛使用，比如：shell、PHP、python、java、js等！</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[root@manage01 ~]# locate sko</span></span>
...
<span class="line"><span>[root@manage01 ~]# updatedb</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、正则表达式特殊字符" tabindex="-1"><a class="header-anchor" href="#_2、正则表达式特殊字符"><span>2、正则表达式特殊字符</span></a></h3><p>定位符使用技巧：同时锚定开头和结尾，做精确匹配；单一锚定开头或结尾或者不锚定的，做模糊匹配。</p><table><thead><tr><th style="text-align:center;">定位符</th><th style="text-align:left;">说明</th></tr></thead><tbody><tr><td style="text-align:center;">^</td><td style="text-align:left;">锚定开头 ^a 以a开头 默认锚定一个字符</td></tr><tr><td style="text-align:center;">$</td><td style="text-align:left;">锚定结尾 a$ 以a结尾 默认锚定一个字符</td></tr></tbody></table><p>测试案例</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>1）精确匹配  以a开头c结尾的字符串</span></span>
...
<span class="line"><span>a3c</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>匹配符:匹配字符串</p><table><thead><tr><th style="text-align:center;">匹配符</th><th style="text-align:left;">说明</th><th></th></tr></thead><tbody><tr><td style="text-align:center;">.</td><td style="text-align:left;">匹配除回车以外的任意一个字符</td><td></td></tr><tr><td style="text-align:center;">( )</td><td style="text-align:left;">字符串分组</td><td></td></tr><tr><td style="text-align:center;">[ ]</td><td style="text-align:left;">定义字符类，匹配括号中的一个字符</td><td></td></tr><tr><td style="text-align:center;">[ ^ ]</td><td style="text-align:left;">表示否定括号中出现字符类中的字符,取反。</td><td></td></tr><tr><td style="text-align:center;">\\</td><td style="text-align:left;">转义字符</td><td></td></tr><tr><td style="text-align:center;">|</td><td style="text-align:left;"></td><td>或</td></tr></tbody></table><p>测试案例</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>1）精确匹配  以a开头c结尾  中间任意  长度为三个字节的字符串</span></span>
...
<span class="line"><span>aZc</span></span>
<span class="line"><span>a c</span></span>
<span class="line"><span>a3c</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>限定符:对前面的字符或者(字符串)出现的次数做限定说明</p>`,22),t=n("table",null,[n("thead",null,[n("tr",null,[n("th",{style:{"text-align":"center"}},"限定符"),n("th",{style:{"text-align":"left"}},"说明")])]),n("tbody",null,[n("tr",null,[n("td",{style:{"text-align":"center"}},"*"),n("td",{style:{"text-align":"left"}},"某个字符之后加星号表示该字符不出现或出现多次 a* (ab)*")]),n("tr",null,[n("td",{style:{"text-align":"center"}},"？"),n("td",{style:{"text-align":"left"}},"与星号相似，但略有变化，表示该字符出现一次或不出现")]),n("tr",null,[n("td",{style:{"text-align":"center"}},"+"),n("td",{style:{"text-align":"left"}},"与星号相似，表示其前面字符出现一次或多次，但必须出现一次")]),n("tr",null,[n("td",{style:{"text-align":"center"},"n,m":""}),n("td",{style:{"text-align":"left"}},"某个字符之后出现，表示该字符最少n次，最多m次")]),n("tr",null,[n("td",{style:{"text-align":"center"},m:""}),n("td",{style:{"text-align":"left"}},"正好出现了m次")])])],-1),c=s(`<p>测试案例</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>1）精确匹配 以a开头 c结尾 中间是有b或者没有b 长度不限的字符串</span></span>
...
<span class="line"><span>acc</span></span>
<span class="line"><span>abc</span></span>
<span class="line"><span>a3c</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>说明：特殊字符和POSIX字符是两套字符，都可以完成需要的匹配，大家学习的时候最少要记住一套字符并熟练应用。</strong></p><h3 id="_4、练习案例" tabindex="-1"><a class="header-anchor" href="#_4、练习案例"><span>4、练习案例</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>1、IP匹配公式</span></span>
<span class="line"><span>grep &#39;^((25[0-5]|2[0-4][[:digit:]]|[01]?[[:digit:]][[:digit:]]?).){3}(25[0-5]|2[0-4][[:digit:]]|[01]?[[:digit:]][[:digit:]]?)$&#39; --color ip_base</span></span>
<span class="line"><span>2、E-MAIL地址匹配公式</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10),d=[p,t,c];function r(v,u){return l(),e("div",null,d)}const m=a(i,[["render",r],["__file","正则表达式.html.vue"]]),g=JSON.parse('{"path":"/note/shell/%E6%AD%A3%E5%88%99%E8%A1%A8%E8%BE%BE%E5%BC%8F.html","title":"22-正则表达式","lang":"zh-CN","frontmatter":{"title":"22-正则表达式","order":22,"icon":"lightbulb","description":"处理海量日志对每一个运维来说都非常的头疼，日志分析我们首先需要把需要的数据从海量的日志中匹配出来，降低数据量，然后在分析这些日志。那么从海量的日志中把我们需要的日志找出来就需要我们写一个公式来匹配，那么如何才能写一个这样的公式呢？ 这节课我就给大家说说正则表达式，看起来比较高大上，其实就是通过给定的符号生成一个字符串匹配的公式，通过该公式把需要的数据匹...","head":[["meta",{"property":"og:url","content":"https://vuepress-theme-hope-docs-demo.netlify.app/vuepress/note/shell/%E6%AD%A3%E5%88%99%E8%A1%A8%E8%BE%BE%E5%BC%8F.html"}],["meta",{"property":"og:site_name","content":"风华"}],["meta",{"property":"og:title","content":"22-正则表达式"}],["meta",{"property":"og:description","content":"处理海量日志对每一个运维来说都非常的头疼，日志分析我们首先需要把需要的数据从海量的日志中匹配出来，降低数据量，然后在分析这些日志。那么从海量的日志中把我们需要的日志找出来就需要我们写一个公式来匹配，那么如何才能写一个这样的公式呢？ 这节课我就给大家说说正则表达式，看起来比较高大上，其实就是通过给定的符号生成一个字符串匹配的公式，通过该公式把需要的数据匹..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"风华"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"22-正则表达式\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"风华\\",\\"url\\":\\"/portfolio\\"}]}"]]},"headers":[{"level":2,"title":"正则表达式","slug":"正则表达式","link":"#正则表达式","children":[{"level":3,"title":"1、正则表达式介绍","slug":"_1、正则表达式介绍","link":"#_1、正则表达式介绍","children":[]},{"level":3,"title":"2、正则表达式特殊字符","slug":"_2、正则表达式特殊字符","link":"#_2、正则表达式特殊字符","children":[]},{"level":3,"title":"3、正则表达式POSIX字符","slug":"_3、正则表达式posix字符","link":"#_3、正则表达式posix字符","children":[]},{"level":3,"title":"4、练习案例","slug":"_4、练习案例","link":"#_4、练习案例","children":[]}]}],"git":{},"readingTime":{"minutes":6.48,"words":1945},"filePathRelative":"note/shell/正则表达式.md","autoDesc":true}');export{m as comp,g as data};
