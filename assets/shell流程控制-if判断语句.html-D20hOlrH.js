...
<span class="line"><span>fi</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、if-else语句" tabindex="-1"><a class="header-anchor" href="#三、if-else语句"><span>三、if…else语句</span></a></h2><p>适用范围==:两步判断，条件为真干什么，条件为假干什么。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>if [ condition ]     </span></span>
...
<span class="line"><span>fi         		结束</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://www.zutuanxue.com:8000/static/media/images/2020/9/25/1601016994805.png" alt="流程判断2.png" tabindex="0" loading="lazy"><figcaption>流程判断2.png</figcaption></figure><p>该语句翻译成汉语大意如下：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>假如条件为真</span></span>
<span class="line"><span>  那么</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>结束</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过一段代码演示一下吧，判断当前登录用户是管理员还是普通用户,如果是管理员输出”hey admin“ 如果是普通用户输出”hey guest“</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>#!/bin/bash</span></span>
<span class="line"><span>#Author:www.zutuanxue.com</span></span>
<span class="line"><span>#Created Time:</span></span>
<span class="line"><span>#Script Description: </span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>fi</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="四、if-elif-else" tabindex="-1"><a class="header-anchor" href="#四、if-elif-else"><span>四、if…elif…else</span></a></h2><p>适用范围:多于两个以上的判断结果，也就是多于一个以上的判断条件。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>if [ condition 1]     满足第一个条件</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>fi    结束判断</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://www.zutuanxue.com:8000/static/media/images/2020/9/25/1601017300715.png" alt="流程判断3.png" tabindex="0" loading="lazy"><figcaption>流程判断3.png</figcaption></figure><p>该语句翻译成汉语大意如下：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>假如 条件1 为真</span></span>
<span class="line"><span></span></span>
<span class="line"><span>      那么</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>结束</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过一段代码演示一下吧，通过一个脚本，判断两个整数的关系</p><p><strong>案例需求</strong> 判断内存的使用率 60以下 ok 60以上 黄色警告 70以上 橙色严重警告 80以上 红色警告</p><p><strong>案例思考</strong></p><ul><li>内存使用率获得方式 – 手动给出 – 通过内存查看命令运算得出</li></ul><p><strong>案例代码</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>#!/bin/bash</span></span>
...
<span class="line"><span>else</span></span>
<span class="line"><span>        echo &quot;$1 &lt; $2&quot;</span></span>
<span class="line"><span>fi</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="六、if嵌套if" tabindex="-1"><a class="header-anchor" href="#六、if嵌套if"><span>六、if嵌套if</span></a></h2><p>当有多步判断的时候，可以使用if嵌套</p><p><strong>1、多步判断 类似于多条件if</strong><strong>2、依赖执行的环境 configure-&gt;make-&gt;make install</strong></p><h4 id="_6-1、使用if嵌套if的方式判断两个整数的关系" tabindex="-1"><a class="header-anchor" href="#_6-1、使用if嵌套if的方式判断两个整数的关系"><span>6.1、使用if嵌套if的方式判断两个整数的关系</span></a></h4><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>#!/bin/bash</span></span>
...
<span class="line"><span>else</span></span>
<span class="line"><span>       echo &quot; $1 = $2 &quot;</span></span>
<span class="line"><span>fi</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_6-2、写一个nginx安装初始化脚本" tabindex="-1"><a class="header-anchor" href="#_6-2、写一个nginx安装初始化脚本"><span>6.2、写一个nginx安装初始化脚本</span></a></h4><p><strong>案例需求</strong> 写一个nginx业务初始化脚本，完成nginx软件自动安装。</p><p><strong>案例思考</strong></p><ul><li>1、nginx软件包获得方式</li><li>2、nginx安装流程</li><li>3、nginx安装依赖关系</li></ul><p><strong>案例步骤</strong></p><ul><li>1、软件包下载</li><li>2、软件包解压</li><li>3、安装依赖包</li><li>4、安装nginx</li><li>5、返回结果</li></ul><p><strong>案例代码</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>#!/bin/bash</span></span>
<span class="line"><span>#Author: www.zutuanxue.com</span></span>
<span class="line"><span>#Created Time: </span></span>
...
<span class="line"><span>fi</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_7-2、使用双方括号-可以在条件中使用通配符" tabindex="-1"><a class="header-anchor" href="#_7-2、使用双方括号-可以在条件中使用通配符"><span>7.2、使用双方括号,可以在条件中使用通配符</span></a></h4><p>通过代码看下 ，为字符串提供高级功能，模式匹配 r* 匹配r开头的字符串</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>#!/bin/bash</span></span>
<span class="line"><span>#Author: </span></span>
<span class="line"><span>#Created Time: </span></span>
<span class="line"><span>#Script Description: </span></span>
...
<span class="line"><span>       fi</span></span>
<span class="line"><span>done</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="八、简写if" tabindex="-1"><a class="header-anchor" href="#八、简写if"><span>八、简写if</span></a></h2><p>省去了关键字，条件为真采用&amp;&amp;符号链接命令块，条件为假采用||链接命令块</p><p>简写if一般用在简单的判断中</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>if [ ! -d /tmp/baism ]</span></span>
<span class="line"><span>    then</span></span>
...
<span class="line"><span>[ $USER == &#39;root&#39; ]&amp;&amp;echo &quot;hello root&quot; || echo &quot;hello guest&quot;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="九、课后练习" tabindex="-1"><a class="header-anchor" href="#九、课后练习"><span>九、课后练习</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>1、计算机状态监控。能ping通就算up，不通为down,需要考虑网络延迟问题造成的假报警问题。</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>10、写一个nginx安装脚本</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,67),p=[l];function d(c,t){return a(),n("div",null,p)}const u=s(e,[["render",d],["__file","shell流程控制-if判断语句.html.vue"]]),m=JSON.parse('{"path":"/note/shell/shell%E6%B5%81%E7%A8%8B%E6%8E%A7%E5%88%B6-if%E5%88%A4%E6%96%AD%E8%AF%AD%E5%8F%A5.html","title":"11-shell流程控制-if判断语句","lang":"zh-CN","frontmatter":{"title":"11-shell流程控制-if判断语句","order":11,"icon":"lightbulb","description":"一、if介绍 如何写一个高可用性的脚本，赋予脚本智能化，赋予脚本执行逻辑。 比如nginx安装脚本中 configure执行成功在执行make, make执行成功在执行make install 上一步错误就不需要执行后面的代码了。 answer: 加入判断 只要你想在代码中判断一下的时候就第一时间想到if就行了，适用于99%的语言。 当我们在写程序的时...","head":[["meta",{"property":"og:url","content":"https://vuepress-theme-hope-docs-demo.netlify.app/vuepress/note/shell/shell%E6%B5%81%E7%A8%8B%E6%8E%A7%E5%88%B6-if%E5%88%A4%E6%96%AD%E8%AF%AD%E5%8F%A5.html"}],["meta",{"property":"og:site_name","content":"风华"}],["meta",{"property":"og:title","content":"11-shell流程控制-if判断语句"}],["meta",{"property":"og:description","content":"一、if介绍 如何写一个高可用性的脚本，赋予脚本智能化，赋予脚本执行逻辑。 比如nginx安装脚本中 configure执行成功在执行make, make执行成功在执行make install 上一步错误就不需要执行后面的代码了。 answer: 加入判断 只要你想在代码中判断一下的时候就第一时间想到if就行了，适用于99%的语言。 当我们在写程序的时..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://www.zutuanxue.com:8000/static/media/images/2020/9/25/1601016825298.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"风华"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"11-shell流程控制-if判断语句\\",\\"image\\":[\\"https://www.zutuanxue.com:8000/static/media/images/2020/9/25/1601016825298.png\\",\\"https://www.zutuanxue.com:8000/static/media/images/2020/9/25/1601016994805.png\\",\\"https://www.zutuanxue.com:8000/static/media/images/2020/9/25/1601017300715.png\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"风华\\",\\"url\\":\\"/portfolio\\"}]}"]]},"headers":[{"level":2,"title":"一、if介绍","slug":"一、if介绍","link":"#一、if介绍","children":[]},{"level":2,"title":"二、单if语法","slug":"二、单if语法","link":"#二、单if语法","children":[]},{"level":2,"title":"三、if…else语句","slug":"三、if-else语句","link":"#三、if-else语句","children":[]},{"level":2,"title":"四、if…elif…else","slug":"四、if-elif-else","link":"#四、if-elif-else","children":[]},{"level":2,"title":"五、练习案例","slug":"五、练习案例","link":"#五、练习案例","children":[]},{"level":2,"title":"六、if嵌套if","slug":"六、if嵌套if","link":"#六、if嵌套if","children":[]},{"level":2,"title":"七、if高级用法","slug":"七、if高级用法","link":"#七、if高级用法","children":[]},{"level":2,"title":"八、简写if","slug":"八、简写if","link":"#八、简写if","children":[]},{"level":2,"title":"九、课后练习","slug":"九、课后练习","link":"#九、课后练习","children":[]}],"git":{},"readingTime":{"minutes":6.61,"words":1984},"filePathRelative":"note/shell/shell流程控制-if判断语句.md","autoDesc":true}');export{u as comp,m as data};
