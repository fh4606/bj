import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,d as i}from"./app-DuswJAHG.js";const l={},e=i(`<p>shell脚本可以让降低大家的工作强度，提升大家的管理能力和薪资报酬，还可以让大家有时间学习提升自己，更能让你有时间喝茶撩妹子。所以，学好shell那就是非常必要的啦，那么在学习shell之前我们得热热身，做一下准备工作了。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>学习之前首先要弄清什么是shell脚本：</span></span>
<span class="line"><span></span></span>
<span class="line"><span>	shell脚本本质上就是要将完成一件事情的所有命令按照执行的先后顺序写入一个文件，并给予文件执行权限</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>so！想学好shell脚本首先要考核一下自己的linux命令学的是否扎实，接下来为了能让大家学习shell更加顺畅，我把常用的一些数据处理的命令给大家回顾一下。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>我们重点回顾以下几类命令</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>source ~/.bashrc</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、cut数据截取" tabindex="-1"><a class="header-anchor" href="#_2、cut数据截取"><span>2、cut数据截取</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>cut用于列截取</span></span>
...
<span class="line"><span># cut -c5- 1.txt 从第5个字符开始截取后面所有字符</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、tr-字符转换-替换-删除" tabindex="-1"><a class="header-anchor" href="#_3、tr-字符转换-替换-删除"><span>3、tr 字符转换：替换，删除</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>tr用来从标准输入中通过替换或删除操作进行字符转换；主要用于删除文件中控制字符或进行字符转换。</span></span>
...
<span class="line"><span># tr -s &#39;[a-z0-9]&#39; &lt; 3.txt 匹配小写字母和数字并将重复的压缩为一个</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4、sort排序" tabindex="-1"><a class="header-anchor" href="#_4、sort排序"><span>4、sort排序</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>sort：将文件的每一行作为一个单位，从首字符向后，依次按ASCII码值进行比较，最后将他们按升序输出。</span></span>
<span class="line"><span></span></span>
<span class="line"><span>语法：</span></span>
...
<span class="line"><span># sort -u 2.txt</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5、uniq-去除连续的重复行" tabindex="-1"><a class="header-anchor" href="#_5、uniq-去除连续的重复行"><span>5、uniq 去除连续的重复行</span></a></h3><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>应用技巧：去重前先使用sort排序</strong></p></div><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>uniq：去除连续重复行</span></span>
<span class="line"><span></span></span>
<span class="line"><span>语法：</span></span>
...
<span class="line"><span># uniq -dc 2.txt</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6、tee-双向输出" tabindex="-1"><a class="header-anchor" href="#_6、tee-双向输出"><span>6、tee 双向输出</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>tee工具从标准输入读取并写入标准输出和文件，即：双向覆盖重定向&lt;屏幕输出|文本输入&gt;</span></span>
...
<span class="line"><span># cat file1</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container caution"><p class="hint-container-title">警告</p><p>-a 双向追加重定向，如果不加-a参数，源文件会被覆盖。</p></div><h3 id="_7、paste" tabindex="-1"><a class="header-anchor" href="#_7、paste"><span>7、paste</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>paste工具用于合并文件行输出到屏幕，不会改动源文件</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>hello</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_8、xargs-上一个命令的输出作为下一个命令的命令行参数" tabindex="-1"><a class="header-anchor" href="#_8、xargs-上一个命令的输出作为下一个命令的命令行参数"><span>8、xargs 上一个命令的输出作为下一个命令的命令行参数</span></a></h3><p>管道(|):上一个命令的输出作为下一个命令的输入，做的是<strong>数据源</strong>。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[root@manage01 ~]# sort -n 2.txt |uniq </span></span>
...
<span class="line"><span>|：               管道符 上一个命令的输出作为下一个命令的输入   cat filename | grep &quot;abc&quot;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container important"><p class="hint-container-title">重要</p><p>难点：单引号与双引号的却别：<strong>单引号不解释变量</strong></p></div><h3 id="_10、组合命令实战" tabindex="-1"><a class="header-anchor" href="#_10、组合命令实战"><span>10、组合命令实战</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>job1: 检索本机的IP、NETMASK、MAC地址、广播地址</span></span>
...
<span class="line"><span>ayitula x /bin/bash</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>案例演示</strong></p><div class="hint-container important"><p class="hint-container-title">重要</p><p>在Rocky9中没有ifconfig命令，需要安装，安装命令：yum install net-tools -y</p></div><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[root@shell ~]# ifconfig ens18|grep -w &quot;inet&quot;|tr -s &quot; &quot;|cut -d &quot; &quot; -f3|xargs echo &quot;IP:&quot;</span></span>
<span class="line"><span>IP: 192.168.11.11</span></span>
<span class="line"><span></span></span>
<span class="line"><span>[root@shell ~]# ifconfig ens18|grep -w &quot;inet&quot;|tr -s &quot; &quot;|cut -d &quot; &quot; -f5|xargs echo &quot;NETMASK:&quot;</span></span>
<span class="line"><span>NETMASK: 255.255.255.0</span></span>
<span class="line"><span></span></span>
<span class="line"><span>[root@shell ~]# ifconfig ens18|grep -w &quot;inet&quot;|tr -s &quot; &quot;|cut -d &quot; &quot; -f7|xargs echo &quot;BROADCAST:&quot;</span></span>
<span class="line"><span>BROADCAST: 192.168.11.255</span></span>
<span class="line"><span></span></span>
<span class="line"><span>[root@shell ~]# ifconfig ens18|grep -w &quot;ether&quot;|tr -s &quot; &quot;|cut -d &quot; &quot; -f3|xargs echo &quot;MAC:&quot;</span></span>
<span class="line"><span>MAC: bc:24:11:27:c3:39</span></span>
<span class="line"><span></span></span>
<span class="line"><span>[root@shell ~]# grep -i &quot;bash&quot; /etc/passwd|grep -v &quot;root&quot;|cut -d &quot;:&quot; -f1,2,7|tr &quot;:&quot; &quot;\\t&quot;</span></span>
<span class="line"><span>userA   x       /bin/bash</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,32),p=[e];function d(c,r){return a(),n("div",null,p)}const u=s(l,[["render",d],["__file","shell脚本中常用命令复习.html.vue"]]),b=JSON.parse('{"path":"/note/shell/shell%E8%84%9A%E6%9C%AC%E4%B8%AD%E5%B8%B8%E7%94%A8%E5%91%BD%E4%BB%A4%E5%A4%8D%E4%B9%A0.html","title":"02-shell脚本中常用命令复习","lang":"zh-CN","frontmatter":{"title":"02-shell脚本中常用命令复习","order":2,"icon":"lightbulb","description":"shell脚本可以让降低大家的工作强度，提升大家的管理能力和薪资报酬，还可以让大家有时间学习提升自己，更能让你有时间喝茶撩妹子。所以，学好shell那就是非常必要的啦，那么在学习shell之前我们得热热身，做一下准备工作了。 so！想学好shell脚本首先要考核一下自己的linux命令学的是否扎实，接下来为了能让大家学习shell更加顺畅，我把常用的一...","head":[["meta",{"property":"og:url","content":"https://vuepress-theme-hope-docs-demo.netlify.app/vuepress/note/shell/shell%E8%84%9A%E6%9C%AC%E4%B8%AD%E5%B8%B8%E7%94%A8%E5%91%BD%E4%BB%A4%E5%A4%8D%E4%B9%A0.html"}],["meta",{"property":"og:site_name","content":"风华"}],["meta",{"property":"og:title","content":"02-shell脚本中常用命令复习"}],["meta",{"property":"og:description","content":"shell脚本可以让降低大家的工作强度，提升大家的管理能力和薪资报酬，还可以让大家有时间学习提升自己，更能让你有时间喝茶撩妹子。所以，学好shell那就是非常必要的啦，那么在学习shell之前我们得热热身，做一下准备工作了。 so！想学好shell脚本首先要考核一下自己的linux命令学的是否扎实，接下来为了能让大家学习shell更加顺畅，我把常用的一..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"风华"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"02-shell脚本中常用命令复习\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"风华\\",\\"url\\":\\"/portfolio\\"}]}"]]},"headers":[{"level":2,"title":"一、 数据处理命令","slug":"一、-数据处理命令","link":"#一、-数据处理命令","children":[{"level":3,"title":"1、grep: 负责从数据源中检索对应的字符串，行过滤。","slug":"_1、grep-负责从数据源中检索对应的字符串-行过滤。","link":"#_1、grep-负责从数据源中检索对应的字符串-行过滤。","children":[]},{"level":3,"title":"2、cut数据截取","slug":"_2、cut数据截取","link":"#_2、cut数据截取","children":[]},{"level":3,"title":"3、tr 字符转换：替换，删除","slug":"_3、tr-字符转换-替换-删除","link":"#_3、tr-字符转换-替换-删除","children":[]},{"level":3,"title":"4、sort排序","slug":"_4、sort排序","link":"#_4、sort排序","children":[]},{"level":3,"title":"5、uniq 去除连续的重复行","slug":"_5、uniq-去除连续的重复行","link":"#_5、uniq-去除连续的重复行","children":[]},{"level":3,"title":"6、tee 双向输出","slug":"_6、tee-双向输出","link":"#_6、tee-双向输出","children":[]},{"level":3,"title":"7、paste","slug":"_7、paste","link":"#_7、paste","children":[]},{"level":3,"title":"8、xargs 上一个命令的输出作为下一个命令的命令行参数","slug":"_8、xargs-上一个命令的输出作为下一个命令的命令行参数","link":"#_8、xargs-上一个命令的输出作为下一个命令的命令行参数","children":[]},{"level":3,"title":"9、shell字符","slug":"_9、shell字符","link":"#_9、shell字符","children":[]},{"level":3,"title":"10、组合命令实战","slug":"_10、组合命令实战","link":"#_10、组合命令实战","children":[]}]}],"git":{},"readingTime":{"minutes":11.53,"words":3460},"filePathRelative":"note/shell/shell脚本中常用命令复习.md","autoDesc":true}');export{u as comp,b as data};
