...
<span class="line"><span>    3)END: 处理完数据流后执行，可选项</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、awk基本应用" tabindex="-1"><a class="header-anchor" href="#_3、awk基本应用"><span>3、awk基本应用</span></a></h3><p>能够熟练使用awk对标准输出的行、列、字符串截取</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>学习用例</span></span>
...
<span class="line"><span>5 the quick brown fox jumps over the lazy cat . dog</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-1-awk对字段-列-的提取" tabindex="-1"><a class="header-anchor" href="#_3-1-awk对字段-列-的提取"><span>3.1）awk对字段(列)的提取</span></a></h3><p>字段提取:提取一个文本中的一列数据并打印输出</p><p>字段相关内置变量</p><p>$0 表示整行文本</p><p>$1 表示文本行中的第一个数据字段</p><p>$2 表示文本行中的第二个数据字段</p><p>$N 表示文本行中的第N个数据字段</p><p>$NF 表示文本行中的最后一个数据字段</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>读入test每行数据并把每行数据打印出来</span></span>
...
<span class="line"><span>dog</span></span>
<span class="line"><span>dog</span></span>
<span class="line"><span>dog</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-2-命令选项详解" tabindex="-1"><a class="header-anchor" href="#_3-2-命令选项详解"><span>3.2）命令选项详解</span></a></h4><p>-F: 指定字段与字段的分隔符</p><p>当输出的数据流字段格式不是awk默认的字段格式时，我们可以使用-F命令选项来重新定义数据流字段分隔符。比如:</p><p>处理的文件是/etc/passwd，希望打印第一列、第三列、最后一列</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[root@zutuanxue ~]# awk -F &#39;:&#39; &#39;{print $1,$3,$NF}&#39; /etc/passwd</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>可以看的出，awk输出字段默认的分隔符也是空格</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>-f file: 如果awk命令是日常重复工作，而又没有太多变化，可以将程序写入文件，每次使用-f调用程序文件就好，方便，高效。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[root@zutuanxue ~]# cat abc </span></span>
...
<span class="line"><span>5 quick dog</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>-v 定义变量，既然作者写awk的时候就是按着语言去写的，那么语言中最重要的要素—变量肯定不能缺席，所以可以使用-v命令选项定义变量</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[root@zutuanxue ~]# awk -v name=&#39;baism&#39; &#39;BEGIN{print name}&#39;</span></span>
<span class="line"><span>baism</span></span>
<span class="line"><span></span></span>
<span class="line"><span>定义了一个变量 name=baism，然后调用变量读出数据。</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-3-awk对记录-行-的提取" tabindex="-1"><a class="header-anchor" href="#_3-3-awk对记录-行-的提取"><span>3.3）awk对记录(行)的提取</span></a></h4><p>记录提取：提取一个文本中的一行并打印输出</p><p>记录的提取方法有两种：a、通过行号 b、通过正则匹配</p><p>记录相关内置变量</p><p>NR: 指定行号 number row</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>提取test第三行数据</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>3 the quick brown fox         jumps over the lazy cat . dog</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-4-awk对字符串提取" tabindex="-1"><a class="header-anchor" href="#_3-4-awk对字符串提取"><span>3.4）awk对字符串提取</span></a></h4><p>记录和字段的汇合点就是字符串</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>打印test第三行的第六个字段</span></span>
<span class="line"><span>[root@zutuanxue ~]# awk &#39;NR==3{print $6}&#39; test</span></span>
<span class="line"><span>jumps</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4、awk程序的优先级" tabindex="-1"><a class="header-anchor" href="#_4、awk程序的优先级"><span>4、awk程序的优先级</span></a></h3><p>awk代码块的优先级</p><p>关于awk程序的执行优先级，BEGIN是优先级最高的代码块，是在执行PROGRAM之前执行的，不需要提供数据源，因为不涉及到任何数据的处理，也不依赖与PROGRAM代码块；PROGRAM是对数据流干什么，是必选代码块，也是默认代码块。所以在执行时必须提供数据源；END是处理完数据流后的操作，如果需要执行END代码块，就必须需要PROGRAM的支持，单个无法执行。</p><p>BEGIN：处理数据源之前干什么 不需要数据源就可以执行</p><p>PROGRAM： 对数据源干什么 【默认必须有】 需要数据源</p><p>END：处理完数据源后干什么 需要program 需要数据源</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>优先级展示</span></span>
...
<span class="line"><span>[root@zutuanxue ~]# awk &#39;END{print &quot;hello world&quot;}&#39;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5、awk高级应用" tabindex="-1"><a class="header-anchor" href="#_5、awk高级应用"><span>5、awk高级应用</span></a></h3><p>awk是一门语言，那么就会符合语言的特性，除了可以定义变量外，还可以定义数组，还可以进行运算，流程控制，我们接下来看看吧。</p><h4 id="_5-1-awk定义变量和数组" tabindex="-1"><a class="header-anchor" href="#_5-1-awk定义变量和数组"><span>5.1）awk定义变量和数组</span></a></h4><p>定义变量</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[root@zutuanxue ~]# awk -v name=&#39;baism&#39; &#39;BEGIN{print name}&#39;</span></span>
<span class="line"><span>baism</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>100</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>b.比较运算，如果比较的是字符串则按ascii编码顺序表比较。如果结果返回为真则用1表示，如果返回为假则用0表示</p><p>ascii</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[root@zutuanxue ~]# awk &#39;BEGIN{print &quot;a&quot; &gt;= &quot;b&quot; }&#39;</span></span>
...
<span class="line"><span>0</span></span>
<span class="line"><span>[root@zutuanxue ~]# awk &#39;BEGIN{print 100 != 1 }&#39;</span></span>
<span class="line"><span>1</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>c.数学运算</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[root@zutuanxue ~]# awk &#39;BEGIN{print 100+3 }&#39;</span></span>
...
<span class="line"><span>1</span></span>
<span class="line"><span>[root@zutuanxue ~]# awk -v &#39;count=0&#39; &#39;BEGIN{count--;print count}&#39;</span></span>
<span class="line"><span>-1</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>d.逻辑运算</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>与运算:真真为真，真假为假，假假为假</span></span>
...
<span class="line"><span>0</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>e.匹配运算</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[root@zutuanxue ~]# awk -F &#39;:&#39; &#39;$1 ~ &quot;^ro&quot; {print $0}&#39; /etc/passwd</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>可以看出，提示符和输出在一行了，因为默认回车换成了*</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_5-4-流程控制" tabindex="-1"><a class="header-anchor" href="#_5-4-流程控制"><span>5.4）流程控制</span></a></h4><p><strong>if判断语句</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>学习用例</span></span>
...
<span class="line"><span>4</span></span>
<span class="line"><span>4.5</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>for循环语句</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>学习用例</span></span>
...
<span class="line"><span>210</span></span>
<span class="line"><span>190</span></span>
<span class="line"><span>210</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>while循环语句</strong>–先判断后执行</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>学习用例</span></span>
<span class="line"><span>[root@zutuanxue ~]# cat num2</span></span>
<span class="line"><span>60 50 100</span></span>
<span class="line"><span>150 30 10</span></span>
<span class="line"><span>70 100 40</span></span>
...
<span class="line"><span>210</span></span>
<span class="line"><span>150</span></span>
<span class="line"><span>170</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>do…while循环语句</strong>–先执行后判断</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>学习用例</span></span>
<span class="line"><span>[root@zutuanxue ~]# cat num2</span></span>
<span class="line"><span>60 50 100</span></span>
<span class="line"><span>150 30 10</span></span>
<span class="line"><span>70 100 40</span></span>
...
<span class="line"><span>210</span></span>
<span class="line"><span>150</span></span>
<span class="line"><span>170</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>循环控制语句</strong></p><p>break 跳出循环,继续执行后续语句</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>学习用例</span></span>
<span class="line"><span>[root@zutuanxue ~]# cat num2</span></span>
<span class="line"><span>60 50 100</span></span>
<span class="line"><span>150 30 10</span></span>
<span class="line"><span>70 100 40</span></span>
...
<span class="line"><span>170</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,100),p=[l];function d(t,c){return a(),n("div",null,p)}const v=s(e,[["render",d],["__file","shell数据筛选与处理.html.vue"]]),b=JSON.parse('{"path":"/note/shell/shell%E6%95%B0%E6%8D%AE%E7%AD%9B%E9%80%89%E4%B8%8E%E5%A4%84%E7%90%86.html","title":"24-shell数据筛选与处理","lang":"zh-CN","frontmatter":{"title":"24-shell数据筛选与处理","order":24,"icon":"lightbulb","description":"聊聊大家常说的数据分析： 数据收集：负责数据的收集 数据清洗：负责数据的筛选 数据分析：数据运算、整理 数据展示：图表或表格方式输出结果 shell脚本数据的处理 1）数据检索:grep tr cut 2）数据处理:uniq sort tee paste xargs 之前的脚本中我们都是通过grep、cut、tr、uniq、sort等命令通过管道组合在...","head":[["meta",{"property":"og:url","content":"https://vuepress-theme-hope-docs-demo.netlify.app/vuepress/note/shell/shell%E6%95%B0%E6%8D%AE%E7%AD%9B%E9%80%89%E4%B8%8E%E5%A4%84%E7%90%86.html"}],["meta",{"property":"og:site_name","content":"风华"}],["meta",{"property":"og:title","content":"24-shell数据筛选与处理"}],["meta",{"property":"og:description","content":"聊聊大家常说的数据分析： 数据收集：负责数据的收集 数据清洗：负责数据的筛选 数据分析：数据运算、整理 数据展示：图表或表格方式输出结果 shell脚本数据的处理 1）数据检索:grep tr cut 2）数据处理:uniq sort tee paste xargs 之前的脚本中我们都是通过grep、cut、tr、uniq、sort等命令通过管道组合在..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"风华"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"24-shell数据筛选与处理\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"风华\\",\\"url\\":\\"/portfolio\\"}]}"]]},"headers":[{"level":2,"title":"shell对输出流的处理-awk","slug":"shell对输出流的处理-awk","link":"#shell对输出流的处理-awk","children":[{"level":3,"title":"1、awk介绍","slug":"_1、awk介绍","link":"#_1、awk介绍","children":[]},{"level":3,"title":"2、awk语法","slug":"_2、awk语法","link":"#_2、awk语法","children":[]},{"level":3,"title":"3、awk基本应用","slug":"_3、awk基本应用","link":"#_3、awk基本应用","children":[]},{"level":3,"title":"3.1）awk对字段(列)的提取","slug":"_3-1-awk对字段-列-的提取","link":"#_3-1-awk对字段-列-的提取","children":[]},{"level":3,"title":"4、awk程序的优先级","slug":"_4、awk程序的优先级","link":"#_4、awk程序的优先级","children":[]},{"level":3,"title":"5、awk高级应用","slug":"_5、awk高级应用","link":"#_5、awk高级应用","children":[]}]}],"git":{},"readingTime":{"minutes":12.61,"words":3782},"filePathRelative":"note/shell/shell数据筛选与处理.md","autoDesc":true}');export{v as comp,b as data};
