import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,d as i}from"./app-DZWWIkr0.js";const e={},l=i(`<p>工作中总是有很多工作需要重复性来完成，比如每天都需要执行一次备份、每天都需要分析一次业务的access.log日志，每分钟都需要监测一次主机的状态等等工作，这些重复性的工作我们一般都是使用脚本来完成，对于不需要频繁执行的任务，可以结合计划任务➕脚本完成，但是系统的计划任务只能精确到分，不能满足更频繁的重复工作。</p><p>这个时候我们除了依赖计划任务之外还有很多选择，比如脚本中的循环语句。</p><p>循环的优点</p><ul><li>1）节省内存 10M脚本 1M脚本 哪个更剩内存 完成同一个任务</li><li>2）结构更清晰</li><li>3）节省开发时间成本</li></ul><h2 id="一、循环语句-for" tabindex="-1"><a class="header-anchor" href="#一、循环语句-for"><span>一、循环语句-for</span></a></h2><h3 id="_1-1、for介绍" tabindex="-1"><a class="header-anchor" href="#_1-1、for介绍"><span>1.1、for介绍</span></a></h3><p>脚本在执行任务的时候，总会遇到需要循环执行的时候，比如说我们需要脚本每隔五分钟执行一次ping的操作，除了计划任务，我们还可以使用脚本来完成，那么我们就用到了循环语句。</p><h3 id="_1-2、for基本语法-for条件循环" tabindex="-1"><a class="header-anchor" href="#_1-2、for基本语法-for条件循环"><span>1.2、for基本语法 for条件循环</span></a></h3><ul><li>列表for循环：用于将一组命令执行<strong>已知的次数</strong>，下面给出了for循环语句的基本格式：</li></ul><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>for variable_name in {list}</span></span>
