import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,d as e}from"./app-DuswJAHG.js";const i={},l=e(`<h2 id="一、案例应用场景" tabindex="-1"><a class="header-anchor" href="#一、案例应用场景"><span>一、案例应用场景</span></a></h2><p>生产环境中的服务器一般会分为系统盘和数据盘两种磁盘，以dell R730举例，该服务器是一个2U的机架式服务器，满载可以挂载14块磁盘[2块在机箱内做系统盘，12块在面板做数据盘]，我们一般的策略是系统盘做raid1，保障系统稳定性12块数据磁盘我们做raid10 或者 raid50，保障数据盘容错的同时还能做到优化IO的效果。</p><p>raid磁盘的容量是一定的，线上的数据又是不断增长的，也就是说总有一天会把你的数据磁盘填满，那怎么办？为了解决这个问题，人们想到了LVM[逻辑卷管理系统]，当前数据盘容量不够用的时候，我们可以通过san存储获得网络磁盘，然后将该网络存储动态加入LVM中的卷组后就可以扩大LV了。整个过程采用在线扩容的方式，不会影响线上业务正是基于这个原因，我们又在系统中把raid数据盘在存数据之前做成了LVM磁盘，方便后续的扩容。</p><p>注意：有数据的磁盘不能再做LVM，因为需要格式化，数据会全部丢失。必须提前布局，否则就得提前准备跑路资金了。</p><h2 id="二、案例需求" tabindex="-1"><a class="header-anchor" href="#二、案例需求"><span>二、案例需求</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>给虚拟机添加一块磁盘(以sdb为例)，要求使用脚本对该磁盘分三个区：</span></span>
...
<span class="line"><span>格式化为xfs,默认开机自动挂载到/data/data2目录</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、案例算法" tabindex="-1"><a class="header-anchor" href="#三、案例算法"><span>三、案例算法</span></a></h2><p>算法：完成一个任务的代码思路。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>脚本思路---算法</span></span>
...
<span class="line"><span>test $? -eq 0&amp;&amp;echo &quot;/dev/vg100/lv100 挂载成功&quot; || echo &quot;/dev/vg100/lv100挂载失败&quot;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="五、实现验证" tabindex="-1"><a class="header-anchor" href="#五、实现验证"><span>五、实现验证</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>使用如下命令查看是否挂载成功</span></span>
<span class="line"><span>[root@zutuanxue ~]# df -Th</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div>`,14),p=[l];function d(c,t){return a(),n("div",null,p)}const u=s(i,[["render",d],["__file","shell脚本实战案例-数据磁盘初始化.html.vue"]]),b=JSON.parse('{"path":"/note/shell/shell%E8%84%9A%E6%9C%AC%E5%AE%9E%E6%88%98%E6%A1%88%E4%BE%8B-%E6%95%B0%E6%8D%AE%E7%A3%81%E7%9B%98%E5%88%9D%E5%A7%8B%E5%8C%96.html","title":"05-案例-数据磁盘初始化","lang":"zh-CN","frontmatter":{"title":"05-案例-数据磁盘初始化","order":5,"icon":"lightbulb","description":"一、案例应用场景 生产环境中的服务器一般会分为系统盘和数据盘两种磁盘，以dell R730举例，该服务器是一个2U的机架式服务器，满载可以挂载14块磁盘[2块在机箱内做系统盘，12块在面板做数据盘]，我们一般的策略是系统盘做raid1，保障系统稳定性12块数据磁盘我们做raid10 或者 raid50，保障数据盘容错的同时还能做到优化IO的效果。 ra...","head":[["meta",{"property":"og:url","content":"https://vuepress-theme-hope-docs-demo.netlify.app/vuepress/note/shell/shell%E8%84%9A%E6%9C%AC%E5%AE%9E%E6%88%98%E6%A1%88%E4%BE%8B-%E6%95%B0%E6%8D%AE%E7%A3%81%E7%9B%98%E5%88%9D%E5%A7%8B%E5%8C%96.html"}],["meta",{"property":"og:site_name","content":"风华"}],["meta",{"property":"og:title","content":"05-案例-数据磁盘初始化"}],["meta",{"property":"og:description","content":"一、案例应用场景 生产环境中的服务器一般会分为系统盘和数据盘两种磁盘，以dell R730举例，该服务器是一个2U的机架式服务器，满载可以挂载14块磁盘[2块在机箱内做系统盘，12块在面板做数据盘]，我们一般的策略是系统盘做raid1，保障系统稳定性12块数据磁盘我们做raid10 或者 raid50，保障数据盘容错的同时还能做到优化IO的效果。 ra..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"风华"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"05-案例-数据磁盘初始化\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"风华\\",\\"url\\":\\"/portfolio\\"}]}"]]},"headers":[{"level":2,"title":"一、案例应用场景","slug":"一、案例应用场景","link":"#一、案例应用场景","children":[]},{"level":2,"title":"二、案例需求","slug":"二、案例需求","link":"#二、案例需求","children":[]},{"level":2,"title":"三、案例算法","slug":"三、案例算法","link":"#三、案例算法","children":[]},{"level":2,"title":"四、代码实现","slug":"四、代码实现","link":"#四、代码实现","children":[]},{"level":2,"title":"五、实现验证","slug":"五、实现验证","link":"#五、实现验证","children":[]}],"git":{},"readingTime":{"minutes":3.15,"words":946},"filePathRelative":"note/shell/shell脚本实战案例-数据磁盘初始化.md","autoDesc":true}');export{u as comp,b as data};
